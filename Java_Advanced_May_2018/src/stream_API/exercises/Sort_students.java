...
public class Sort_students {
  public static void main(String[] args) throws IOException {
    ...
    Comparator<Student> compareByLastName =
            (student1, student2) -> student1.getLastName().compareTo(student2.getLastName());
    Comparator<Student> compareByName =
            (student1, student2) -> student2.getName().compareTo(student1.getName());
